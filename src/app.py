...
activities = {
    ...
    "Volleyball Team": {
        "description": "Competitive volleyball team for students interested in team sports",
    ...
    "Art & Drawing": {
        "description": "Explore various painting, drawing, and sculptural techniques",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    if email in activity["participants"]:
        raise HTTPException(status_code=400, detail=f"Already registered for {activity_name}")
